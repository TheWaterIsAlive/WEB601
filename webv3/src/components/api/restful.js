...
router.put(
  "/bussnesses/:name",
  jsonParser,
  routes.listBussness.putBussnessKnex
);
...
router.get(
  "/menuItem/:id",
  middleware.checkID,
  routes.listMenuItem.getSingleMenuItemKnex
); // This uses  middle wear to make sure that the infomraiton past iin is an interger
router.post("/menuItem", jsonParser, routes.listMenuItem.postMenuItemKnex);
router.put(
  "/menuItem/:id",
  jsonParser,
  middleware.checkID,
  routes.listMenuItem.putMenuItemKnex
);
router.delete(
  "/menuItem/:id",
  middleware.checkID,
  routes.listMenuItem.deleteMenuItemKnex
);
