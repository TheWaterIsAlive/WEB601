...
const slideImages = [ 
  // Array of images used in slide show
...
const properties = {
  duration: 5000,
  transitionDuration: 500, //properties of the slide shows transitions
  infinite: true,
  indicators: true,
  arrows: true,
...
//Creates three looping images each with their own text anbd styles
...
//Needs to be updated with react bootstrap
